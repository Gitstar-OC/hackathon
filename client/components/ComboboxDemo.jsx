...
const metrics = [
  ...
  {
    value: "Emissions per 100 grams of protein",
    label: "Emissions per 100 grams of protein",
  },
  {
    value: "Emissions per 100 grams of fat",
    label: "Emissions per 100 grams of fat",
  },
];
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          <CaretSortIcon className="mr-1 left-0 h-4 w-4 shrink-0 opacity-50" />
          {selectedMetric}
        </Button>
      </PopoverTrigger>
